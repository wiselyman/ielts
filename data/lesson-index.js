// Generated from the lesson source data. Keep this file lightweight for homepage/list loading.
window.videoLessons = [
  {
    "id": "bbc-easy-daily-routine",
    "path": "bbc-easy-daily-routine.html",
  ...
  },
  {
    ...
    "path": "bbc-easy-likes-dislikes.html",
...
window.lessonSummaries = {
  ...
  "bbc-6min-reading": "这节课讨论读写能力（literacy）如何改变成年人生活，适合教育、就业和社会流动类 IELTS 话题。视频通过孟加拉和英国的成人学习项目说明：不会阅读会影响通勤（commute）、购买食品杂货（groceries）、签名（signature）、基本计算能力（numeracy）和自我尊严。重点表达包括不识字（illiterate）、欺骗（cheat）以及把能力想当然（take for granted）。",
  ...
  "british-council-talk-about-job": "这节 British Council 课程讲如何用英语介绍自己的工作，适合雅思 5.5 分左右学习者。视频不只是简单说 I have a job，而是练习职位角色（role）、公司（company）、职责（be responsible for）、管理（manage）、内容制作（content producer）、社交媒体（social media）和市场营销（marketing）等表达。它适合 IELTS 工作、职业、团队和自我介绍类话题，也能帮你把“我的工作是什么”说得更具体。"
};
