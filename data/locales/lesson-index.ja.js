...
window.lessonIndexLocale = {
  "summaries": {
    ...
    "bbc-6min-reading": "読み書き能力（literacy）が大人の生活をどう変えるかを扱うレッスンです。教育、仕事、社会的流動性の IELTS トピックに役立ちます。通勤（commute）、食料雑貨（groceries）、署名（signature）、基本的な計算力（numeracy）、尊厳に関わる内容が出てきます。重要表現は illiterate、cheat、take for granted などです。",
