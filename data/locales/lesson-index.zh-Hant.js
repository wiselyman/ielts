...
window.lessonIndexLocale = {
  "summaries": {
    ...
    "ted-ed-procrastination": "這節 TED-Ed 短片解釋為什麼人明知拖延有害卻仍會拖延，適合雅思 5.5 分左右學習者訓練學習習慣、心理壓力和自我管理話題。課程重點包括拖延症（procrastination）、推遲任務（put off）、專心開始做事（buckle down）、時間管理（time management）、負面後果（negative consequences）、非理性的（irrational）、調節情緒（regulate emotions）、畏懼感（dread）、自我懷疑（insecurity）、感知或看法（perception）、易受影響的（susceptible）、自尊（self-esteem）、誤解（misconception）、達到標準（live up to）、長期來看（in the long run）、強化（reinforce）、培養（cultivate）和善待自己（self-compassion）。",
