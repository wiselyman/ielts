...
window.lessonIndexLocale = {
  "summaries": {
    ...
    "bbc-plastic-enzymes": "这节 BBC 6 Minute English 课程讨论科学家如何用酶处理塑料垃圾，适合雅思 5.5 分左右学习者训练环保与基础科技话题。课程重点包括微粒（microparticles）、化学回收（chemical recycling）、开创性的（groundbreaking）、焚烧（incinerate）、垃圾填埋（landfill）、重新塑形（remould）、易碎的（brittle）、降级回收（downcycling）、酶（enzyme）、化学键（chemical bonds）、微生物（microorganism）、堆肥（compost）和尼龙（nylon）。",
